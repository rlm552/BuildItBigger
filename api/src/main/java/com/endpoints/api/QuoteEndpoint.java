...
import static com.endpoints.api.OfyService.ofy;
...
@Api(name = "quoteEndpoint", version = "v1", namespace = @ApiNamespace(ownerDomain = "api.endpoints.com", ownerName = "api.endpoints.com", packagePath=""))
