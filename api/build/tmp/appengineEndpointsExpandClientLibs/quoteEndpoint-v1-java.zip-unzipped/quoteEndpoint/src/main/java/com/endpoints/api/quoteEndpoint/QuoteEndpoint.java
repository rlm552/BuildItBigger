 ...
 * on 2017-04-27 at 06:14:24 UTC 
 * Modify at your own risk.
 */

package com.endpoints.api.quoteEndpoint;
...
public class QuoteEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://endpoints9-162902.appspot.com/_ah/api/";
   ...
   *
   * @param content the {@link com.endpoints.api.quoteEndpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.endpoints.api.quoteEndpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteEndpointRequest<com.endpoints.api.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.endpoints.api.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "POST", REST_PATH, content, com.endpoints.api.quoteEndpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteEndpointRequest<com.endpoints.api.quoteEndpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(QuoteEndpoint.this, "GET", REST_PATH, null, com.endpoints.api.quoteEndpoint.model.CollectionResponseQuote.class);
    }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.endpoints.api.quoteEndpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteEndpointRequest<com.endpoints.api.quoteEndpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.endpoints.api.quoteEndpoint.model.Quote content) {
      super(QuoteEndpoint.this, "PUT", REST_PATH, content, com.endpoints.api.quoteEndpoint.model.Quote.class);
    }
